 ...
 *
 * Convention-matched to AnomalyTargeting / AnomalyArgs: free functions in Public/ with the API macro; the
...
namespace AnomalyLod
{
	 ...
	 * Substring (AnomalyTargeting's label-free rule). Merges FindComponentsMatching<UStaticMeshComponent>
